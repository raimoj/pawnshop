// LainaRS.cpp : implementation file
//
...
IMPLEMENT_DYNAMIC(CLainaRS, CRecordset)

CLainaRS::CLainaRS(CDatabase* pdb)
	: CRRecordset(pdb)
{
	//{{AFX_FIELD_INIT(CLainaRS)
	m_LA_Nr = 0;
...
/*CString CLainaRS::GetDefaultConnect()
{
	return _T("ODBC;DSN=Panttitietokanta");
}*/

CString CLainaRS::GetDefaultSQL()
{
	//return _T("[dbo].[LAINA]");
	return _T("[LAINA]");
}

void CLainaRS::DoFieldExchange(CFieldExchange* pFX)
{
	//{{AFX_FIELD_MAP(CLainaRS)
...
/////////////////////////////////////////////////////////////////////////////
// CLainaRS diagnostics

#ifdef _DEBUG
void CLainaRS::AssertValid() const
{
	CRRecordset::AssertValid();
}

void CLainaRS::Dump(CDumpContext& dc) const
{
	CRRecordset::Dump(dc);
}
#endif //_DEBUG
